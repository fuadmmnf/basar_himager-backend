...
Route::get('/download/report/loandisbursement/{client_id}/start/{start_date}/end/{end_date}',[\App\Http\Controllers\ReportController::class,'getDateWiseLoandisbursmentReportByClientId']);
